...
export default function SponsorsSection() {
  return (
    <section
      id="sponsors"
      className="py-24 h-screen  bg-slate-950/20 border-t border-slate-900/60 overflow-hidden"
    >
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 max-w-xl mx-auto">
          {SPONSORS.map((sp, idx) => (
            <CometCard>
              <button
                type="button"
                className="my-10 flex cursor-pointer flex-col items-stretch rounded-[16px] border-0 bg-[#1F2121]"
              ...
              >
                <div
                  key={idx}
                  className="px-10 py-5 rounded-xl bg-slate-900/20 border border-slate-800 hover:border-blue-500/40 hover:bg-slate-900/50 transition-all flex items-center gap-3 group cursor-pointer w-sm"
                >
