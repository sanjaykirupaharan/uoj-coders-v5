    ...
    <section id="contact" className="text-center py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative border-t border-slate-900/60  h-screen">
      <div className="gap-12 items-center">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="text-xs font-varino text-pink-400 uppercase tracking-widest">// 05 . ESTABLISH COMM LINK</div>
          <h2 className="text-3xl sm:text-4xl font-cust font-bold bg-gradient-to-r from-violet-500 via-cyan-400 to-indigo-500 bg-clip-text text-transparent w-fit mx-auto">INITIALIZE HANDSHAKE</h2>
