    ...
    <section id="about" className=" text-center  py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative border-t border-slate-900/60">
      <div className="gap-12 items-center">
        <div className="text-center space-y-3 mb-16">
          ...
          <h2 className="text-4xl sm:text-4xl font-varino font-bold tracking-tight text-white">UOJ CODERS</h2>
          <p className="text-slate-300 text-xl leading-relaxed font-normal">
        ...
        <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-6 rounded-xl bg-slate-900/20 border border-slate-800/80 backdrop-blur-sm">
            <Trophy className="text-blue-400 mb-4" size={24} />
          ...
          <div className="p-6 rounded-xl bg-slate-900/20 border border-slate-800/80 backdrop-blur-sm">
            <Eye className="text-teal-400 mb-4" size={24} />
          ...
          <div className="p-6 rounded-xl bg-slate-900/20 border border-slate-800/80 backdrop-blur-sm">
            <Moon className="text-purple-400 mb-4" size={24} />
            <div className="text-2xl font-bold font-varino text-white">3 Tracks</div>
            <div className="text-xs text-slate-500 mt-1">Ascent, Lunar, and Deep Core</div>
          </div>
        </div>
      </div>
    </section>
