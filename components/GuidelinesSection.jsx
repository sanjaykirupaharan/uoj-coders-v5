          ...
          {activeTab === "rules" && (
            ...
            >
              ...
              <div className="flex items-start gap-3">
                ...
                />
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed font-normal">
                  Team members must solve the problems without any assistance
                  from other people, pre-written code, or AI tools. Plagiarized
              ...
              <div className="flex items-start gap-3">
                ...
                />
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed font-normal">
                  All final decisions will be made by the Computer Society
                  (CompSoc), University of Jaffna.
                </p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2
                ...
                />
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed font-normal">
                  The final round will take place from July 18th at 6 PM to July
                  19th at 6 AM, 2026, at the Department of Computer Science,
          ...
          {activeTab === "eligibility" && (
            ...
            >
              <div className="flex items-start gap-3">
                ...
                />
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed font-normal">
                  <strong>Undergraduates:</strong> Only exclusive to
                  undergraduate students currently enrolled in Sri Lankan
              ...
              <div className="flex items-start gap-3">
                ...
                />
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed font-normal">
                  <strong>Members:</strong> Each team can consist of a minimum
                  of 1 and a maximum of 3 members.
                </p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2
                ...
                />
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed font-normal">
                  <strong>Team:</strong> All the members in the team must be
